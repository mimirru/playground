def get_birth_date
	puts "Please enter you birthday (MMDDYYYY): "
	
	birthdate = gets
	birth_path(birthdate)
...
def birth_path(birthdate)
	...
	total_num = num[0].to_i + num[1].to_i
	
	if total_num > 9
		total_num = total_num.to_s
		total_num = total_num[0].to_i + total_num[1].to_i
	end
	message(total_num)
end


def message(total_num)
